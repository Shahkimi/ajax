                    ...
                    <div class="card-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb pt-2 pb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('ptj.index') }}">Home</a></li>
        ...
        <div class="modal fade" id="editBahagianModal" tabindex="-1" aria-labelledby="editBahagianModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editBahagianForm" action="{{ route('ptj.bahagian.update', ':id') }}" method="POST">
                            @csrf
                            @method('PUT')
    ...
    <script>
        $(document).ready(function() {
            ...
            function editBahagian(id) {
                $.ajax({
                    url: "{{ route('ptj.bahagian.edit', ':id') }}".replace(':id', id),
                    type: 'GET',
                    success: function(response) {
