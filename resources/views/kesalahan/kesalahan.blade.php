        ...
        <div class="row w-100" style="max-width: 1000px;">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Kesalahan</h2>
                    <a class="btn btn-success" onClick="add()" href="javascript:void(0)"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Kesalahan</a>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="kesalahan">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th style="width: 1px; white-space: nowrap; text-align: center;">Kod Kesalahan</th>
                                        <th>Deskripsi</th>
                                ...
                                <tbody>
                                    @foreach ($kesalahan as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center">{{ $item->kod_kesalahan }}</td>
